...
export default function SignupPage() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-100 dark:bg-gray-900">
          <section className="flex min-h-screen bg-zinc-50 px-4 py-16 md:py-32 dark:bg-transparent w-[100%]"
        style={{
            ...
            <form
                ...
                <div className="p-8 pb-6">
                    ...
                    <div className="space-y-5">
                        ...
                        <Button className="w-full" formAction={signup}>Continue</Button>
                    </div>
                </div>
                <div className="bg-muted rounded-(--radius) border p-3">
                    <p className="text-accent-foreground text-center text-sm">
                        Have an account ?
                            <Link href="/login" style={{color: "#0099FF", fontSize: "13px", marginLeft: "2px", cursor: "default"}}>Sign In</Link>
                    </p>
                </div>
            </form>
        </section>
