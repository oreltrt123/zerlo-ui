...
export default async function Navbar() {
  ...
  return (
    <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 w-[95%] max-w-7xl z-50">
      <div className="bg-[#ffffff] border border-[#0099ff21] backdrop-blur-md rounded-full px-6 py-3 flex items-center justify-between" 
      >
        {/* Logo Section */}
        ...
        <div className="flex-1 flex justify-center gap-6 relative left-[50px]">
          <Link
            href="/blog"
        ...
        <div className="flex items-center gap-4">
          ...
          <Link href="https://github.com/oreltr123/zerlo-ui" target="_blank" rel="noopener noreferrer">
            <Button
              variant="ghost"
              size="icon"
              className="text-black/70 hover:text-black/60 transition-colors duration-200"
