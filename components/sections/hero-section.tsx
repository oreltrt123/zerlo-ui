        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 py-20 text-center top-[-90px]">
          <div className="max-w-2xl mx-auto">
            ...
            <motion.p
              ...
              className="text-gray-600 relative top-[-10px] font-sans font-light"
              dangerouslySetInnerHTML={{ __html: 'Build games. <span className="bg-[#8888881A]">Build</span> graphics. <span className="bg-[#8888881A]">Build</span> sound. Build everything — in a single <span className="bg-[#8888881A] text-[#0099FF]">prompt.</span>' }}
            />
            <motion.div
              initial={{ y: 20, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
...
//       className="relative min-h-screen w-full flex items-center justify-center overflow-hidden"
// style={{
//   backgroundSize: "78%",         // zooms in the image (try 120%–200%)
//   backgroundPosition: "center",
//   backgroundRepeat: "no-repeat",
//   backgroundImage: 'url("/test2.jpeg")',
//   width: "100vw",
//   height: "100vh",
// }}
...
//       <div className="z-10">
//         {/* Content */}
//         <div className="relative z-10 container mx-auto px-4 md:px-6 py-20 text-center top-[-190px] left-[12px]">
//           <div className="max-w-2xl mx-auto">
//             <motion.h1
//               initial={{ y: 20, opacity: 0 }}
//               animate={{ y: 0, opacity: 1 }}
//               transition={{ delay: 0.5, duration: 0.8, ease: "easeOut" }}
//               className="text-3xl text-gray-900 font-sans font-light leading-relaxed max-w-3xl mx-auto"
//               dangerouslySetInnerHTML={{ __html: currentTexts.title }}
//             />
//             <motion.p
//               initial={{ y: 20, opacity: 0 }}
...
//               transition={{ delay: 0.6, duration: 0.8, ease: "easeOut" }}
//               className="text-gray-600 relative top-[-10px] font-sans font-light"
//               dangerouslySetInnerHTML={{ __html: 'Build games. <span className="bg-[#8888881A]">Build</span> graphics. <span className="bg-[#8888881A]">Build</span> sound. Build everything' }}
//             />
//             <motion.div
//               initial={{ y: 20, opacity: 0 }}
//               animate={{ y: 0, opacity: 1 }}
