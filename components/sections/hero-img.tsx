...
en: {
  heading: "Zerlo: AI Game Builder",
  description: "Describe your game idea, and watch AI instantly generate code, assets, and logic. Launch your first game in seconds.",
  linkText: "Start building your game &rarr;",
  placeholder: "Start building your game →",
  suggestions: [
    "Reporting Dashboard",
    "Gaming Platform",
    "Onboarding Portal",
